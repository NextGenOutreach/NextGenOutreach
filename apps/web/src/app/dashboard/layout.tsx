...
const NAV_BY_ROLE: Record<string, { name: string; href: string; icon: string }[]> = {
  client: [
    ...
    { name: 'Prospects',   href: '/dashboard/client/prospects',   icon: '👥' },
    { name: 'ROI',         href: '/dashboard/client/roi',         icon: '📈' },
  ...
  rep: [
    ...
    { name: 'Workspace',    href: '/dashboard/rep/workspace',    icon: '🖥️' },
    { name: 'Daily Report', href: '/dashboard/rep/daily-report', icon: '📋' },
  ...
  admin: [
    ...
    { name: 'Browser Profiles', href: '/dashboard/admin/browser-profiles',  icon: '🖥️' },
    { name: 'Proxies',          href: '/dashboard/admin/proxies',           icon: '🛡️' },
    { name: 'Leaderboard',      href: '/dashboard/admin/leaderboard',       icon: '🏆' },
    { name: 'Messages',         href: '/dashboard/comms',                   icon: '💬' },
